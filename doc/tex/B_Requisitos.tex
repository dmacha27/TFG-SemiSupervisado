...
diferenciarse: Usuario, Administrador y Anónimo (así lo denomina el sistema de
gestión de cuentas utilizado \texttt{Flask-Login}). 

\begin{itemize}
	\item Anónimo: Usuario que no posee una cuenta registrada en el sistema, es
	el usuario base. Puede utilizar, sin límites, toda la aplicación:
	seleccionar algoritmo, subir un conjunto de datos, configurar el algoritmo y
	visualizarlo.
	...
	\item Administrador: Usuario que posee una cuenta registrada sin
