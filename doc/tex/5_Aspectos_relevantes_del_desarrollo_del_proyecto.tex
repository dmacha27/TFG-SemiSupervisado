...
\imagen{memoria/Breast}{Comparación con \textit{Breast Cancer}.}{1}

\imagen{memoria/Iris}{Comparación con \textit{Iris}.}{1}

\imagen{memoria/Wine}{Comparación con \textit{Wine}.}{1}
