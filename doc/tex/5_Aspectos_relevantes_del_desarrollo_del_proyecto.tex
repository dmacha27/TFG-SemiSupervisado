...
<<\emph{backend}>>, que al ser Python, ya se tenía cierta soltura). Para
intentar avanzar lo máximo posible, se optó por ver tutoriales y
...
ejemplo, el uso de <<\emph{imports}>> permitía centralizar y reutilizar código
(que al principio se desconocía).
