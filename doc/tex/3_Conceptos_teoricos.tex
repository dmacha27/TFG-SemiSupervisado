...
se hace <<vaciar>> el conjunto de datos seleccionados para él, $L_i$. En segundo
lugar, se realiza una estimación del error de la combinación de las hipótesis
$h_j$ y $h_k$ \footnote{El error de clasificación se aproxima dividiendo el
número de instancias (de entrenamiento) en las que $h_j$ y $h_k$ se equivocan
entre el número de instancias en las que predicen la misma etiqueta
