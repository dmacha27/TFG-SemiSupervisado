...
\begin{algorithm}
    \KwIn{Conjunto de datos etiquetados \textbf{L}, 
    no etiquetados \textbf{U} y clasificador \textbf{H}}
    \KwOut{Clasificador}
     \While{$|U| \neq 0$}{
        Entrenar \textbf{H} con \textbf{L}\;
        Predecir etiquetas de \textbf{U}\;
        Seleccionar un conjunto \textbf{T} con aquellos datos que tenga la mayor probabilidad\;
        $L = L \cup T$
        $U = U - T$
     }
     Entrenar \textbf{H} con \textbf{L}\;
     \textbf{return} \textbf{H}
