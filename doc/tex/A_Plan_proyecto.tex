...
ejemplo, al final del todo, se añadió el estilo responsivo a estas tablas. La
ventaja fue que DataTables ya tenía extensiones que realizaban esto
automáticamente.
...
Además de todo esto, se hicieron algunos cambios pequeños: Footer al final de la
página, selección de fuentes para la página, arreglar algunos bugs o estilar el
<<card>> del perfil.
...
permite esto) que detecta si existe un parámetro <<lang>> (?lang=X) y si lo hay,
establece el idioma a este (guardándolo en la sesión). De esta forma se consigue
...
codificado. La ventaja es que, aunque se tuvo que añadir bastantes cosas, ya se
tenía el conocimiento previo fue más laborioso (el desarrollo anterior se
