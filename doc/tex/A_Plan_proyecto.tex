...
un modelo de un robot en Dall-e\footnote{https://openai.com/dall-e-2} (consejo
de los tutores). A partir de aquí, se fue modificando el logo base adecuándolo
al contexto de los algoritmos.
\begin{itemize}
...
entres 35 (a partir de este los números se solapaban) y ese resultado actúa de
...
Para los anexos, también se fue incorporando los elementos que faltaban (como el
diagrama de componentes) y completando aquellas partes con alguna explicación
...
El total, para los 5 meses de duración aproximada es 11.597,7\texteuro.
...
\textbf{Total}             & 13.530,3                     \\ \midrule
\end{tabular}
\caption{Coste total}
\label{tabla:total}
\end{table}

El coste total del proyecto, finalmente, es de 13.530,3\texteuro.
