...
dentro de \texttt{gettext}, sin embargo, al indicar las traducciones en
JavaScript, el intérprete tomaba \texttt{gettext} como una función que al no
estar definida, lanzaba error. Al final se generó una función en la plantilla
principal de tal forma que actúe como \texttt{gettext}, llamada desde los
distintos scripts.
...
generación de los gráficos Burndown (ver Imagen~\ref{fig:anexos/sprints/sprint8}).

\imagen{anexos/sprints/sprint8}{Burndown chart del sprint 8.}
...
El gráfico Burndown se visualiza en la imagen~\ref{fig:anexos/sprints/sprint9}.
\imagen{anexos/sprints/sprint9}{Burndown chart del sprint 9.}
...
de cada algoritmo por separado. Cuando se crearon estos métodos se generó código
...
El gráfico Burndown se visualiza en la imagen~\ref{fig:anexos/sprints/sprint10}.
\imagen{anexos/sprints/sprint10}{Burndown chart del sprint 10.}
...
Co-Training tenía peor rendimiento que el de \texttt{sslearn}. Y esto impedía
...
El gráfico Burndown se visualiza en la imagen~\ref{fig:anexos/sprints/sprint11}.
\imagen{anexos/sprints/sprint11}{Burndown chart del sprint 11.}
...
\begin{enumerate}
    ...
    \item Normalización en la configuración
\end{enumerate}
...
siguiente reto fue crear otras peticiones como respuesta a los clicks de estos
...
conveniente permitir al usuario normalizar o no el conjunto de datos a mostrar
(hasta ahora siempre se normalizaba), se incluyó un interruptor para ello.
