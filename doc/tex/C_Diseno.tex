...
protocolo HTTP (los conceptos pueden encontrarse en la memoria). Aquí aparece el
...
\imagencontamano{anexos/diseño/DiagramaDespliegue}{Diagrama de despliegue.}{0.7}
