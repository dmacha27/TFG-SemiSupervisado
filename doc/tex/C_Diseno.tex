...
\imagencontamano{anexos/ProcedimientoWeb}{Diagrama de secuencia de la interacción Web}{1.1}
...
\imagen{anexos/mockups/MUP_Inicio}{Página inicial de la Web.}
...
\imagen{anexos/mockups/MUP_ConfAlgoritmo}{Página de configuración del algoritmo.}
...
\imagen{anexos/mockups/MUP_Algoritmo}{Página de ejecución del algoritmo.}
...
\imagen{anexos/mockups/MUP_NAVBAR}{Barra de navegación principal}
\imagen{anexos/mockups/MUP_NAVBAR_LOGGED}{Barra de navegación con usuario}
\imagen{anexos/mockups/MUP_NAVBAR_HOVER}{Animación <<hover>> en barra de navegación}
\imagen{anexos/mockups/MUP_MIESPACIO}{Espacio personal del usuario}
\imagen{anexos/mockups/MUP_PERFIL}{visualización del perfil y modificación}