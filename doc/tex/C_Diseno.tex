...
\imagen{MUP_Inicio}{Página inicial de la Web.}{1}
...
\imagen{MUP_ConfAlgoritmo}{Página de configuración del algoritmo.}{1}
...
\imagen{MUP_Algoritmo}{Página de ejecución del algoritmo.}{1}
