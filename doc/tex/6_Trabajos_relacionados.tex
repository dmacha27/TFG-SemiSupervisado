...
consideraciones a tener en cuenta para el desarrollo de una buena visualización.
...
\imagen{algorithm-visualizer}{K-Means Clustering en algorithm-visualizer}{1}
...
\imagen{visualgo}{Viajante de comercio en visualgo}{1}
...
\imagen{visualizer}{Mergesort en Visualizer (Zhenbang Feng)}{1}
...
muestra cuál es la evolución/posición de los distintos clusters y mediante línea
es posible ver las distancias en ellos y los datos.

\imagen{Clutering-Visualizer}{K-Means en Clutering-Visualizer}{1}
...
\imagen{MLDemos}{Clasificación mediante Support Vector Machine en MLDemos}{1}
