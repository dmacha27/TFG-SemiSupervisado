...
\begin{table}[]
    ...
    \textbf{\begin{tabular}[c]{@{}l@{}}Incrementar\\ comprensión\end{tabular}} & \begin{tabular}[c]{@{}l@{}}Explicaciones textuales\\ Realimentación con las acciones del usuario\\ Ayuda integrada\\ Comodidad en la entrada de datos\end{tabular}                                                              \\ \hline
    \textbf{\begin{tabular}[c]{@{}l@{}}Promocionar\\ interés\end{tabular}}     & \begin{tabular}[c]{@{}l@{}}Permitir introducir datos al algoritmo\\ Manipular la visualización\\ Capacidad de volver "\textless{}rebobinar"\textgreater\\ Variación de la velocidad\\ Avanzar en la ejecución\end{tabular}         \\ \hline
    ...
    \caption{Características que influencian los objetivos pedagógicos}
\label{tabla:objetivospedagogicos}
    \end{table}


\subsubsection{Interactive System for Algorithm and Data Structure
Visualization} 

En la línea del anterior artículo en \cite{perhavc2022interactive} se presenta
un proyecto en desarrollo de una página abierta para la visualización de
algoritmos interactivos. En el que precisamente la "<interactividad"> busca
conseguir esos objetivos anteriores (pedagogía, usabilidad y accesibilidad).
