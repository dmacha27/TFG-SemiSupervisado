...
\newcommand{\nombre}{David Martínez Acha} %%% cambio de comando

% Datos de portada
\title{Herramienta docente para la visualización en Web de algoritmos de aprendizaje Semi-Supervisado}
\author{\nombre}
...
\noindent Que el alumno D. \nombre, con DNI 71310644H, ha realizado el Trabajo final de Grado en Ingeniería Informática titulado título de TFG. 
